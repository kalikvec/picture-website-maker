...
public class ExifProcessorTest
{
  public void testLoadFujiFilmJpeg() throws Exception
  {
    ...
    // TODO decide if this should still be returned -- it was being calculated upon setting of a related tag assertEquals("F9",
    // directory.getDescription(ExifDirectory.TAG_APERTURE));
  }
