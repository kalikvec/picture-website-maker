...
public class NikonType1MakernoteDirectory extends Directory
{
  ...
  static
  {
    tagNameMap.put(TAG_NIKON_TYPE1_CCD_SENSITIVITY, "CCD Sensitivity");
    tagNameMap.put(TAG_NIKON_TYPE1_COLOR_MODE, "Color Mode");
    tagNameMap.put(TAG_NIKON_TYPE1_DIGITAL_ZOOM, "Digital Zoom");
    tagNameMap.put(TAG_NIKON_TYPE1_CONVERTER, "Fisheye Converter");
    tagNameMap.put(TAG_NIKON_TYPE1_FOCUS, "Focus");
    tagNameMap.put(TAG_NIKON_TYPE1_IMAGE_ADJUSTMENT, "Image Adjustment");
    tagNameMap.put(TAG_NIKON_TYPE1_QUALITY, "Quality");
    tagNameMap.put(TAG_NIKON_TYPE1_UNKNOWN_1, "Makernote Unknown 1");
    tagNameMap.put(TAG_NIKON_TYPE1_UNKNOWN_2, "Makernote Unknown 2");
    tagNameMap.put(TAG_NIKON_TYPE1_UNKNOWN_3, "Makernote Unknown 3");
    tagNameMap.put(TAG_NIKON_TYPE1_WHITE_BALANCE, "White Balance");
  }
